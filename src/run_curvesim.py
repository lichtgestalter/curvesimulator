...
def main():
    ...
    # curvesimulation = CurveSimulator(config_file="../configurations/TOI4504/TOI-4504_X055.ini")
    curvesimulation = CurveSimulator(config_file="../configurations/TOI4504/TOI-4504_X056.ini")
