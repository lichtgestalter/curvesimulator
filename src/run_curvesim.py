...
def main():
    curvesimulation = CurveSimulator(config_file="../configurations/TOI-4504_mcmc_b.ini")
    # curvesimulation = CurveSimulator(config_file="../configurations/TOI-4504_fitb.ini")
