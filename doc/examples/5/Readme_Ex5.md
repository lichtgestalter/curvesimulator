# Example 5: Fitting Flux with MCMC

## What it does
Running `run_example5.py` reads `config5.ini`, which instructs the program to:
- read `flux.csv`
...
| File                           | Description                                                                                           |
|--------------------------------|-------------------------------------------------------------------------------------------------------|
| run_example5.py                | Execute this Python script to run this example yourself.                                              |
| **Input:**                     |                                                                                                       |
| config5.ini                    | This configuration file controls what CurveSimulator does.                                            |
| flux.csv                       | Transit Time Observations                                                                             |
