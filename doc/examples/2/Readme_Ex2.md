...
## What it does
Running `run_example2.py` reads `config2.ini`, which instructs the program to:
...
| File            | Description                                                                                      |
|-----------------|--------------------------------------------------------------------------------------------------|
| run_example2.py | Execute this Python script to run this example yourself. It uses a Windows-safe main entrypoint. |
| **Input:**      |                                                                                                  |
| config2.ini     | This configuration file controls what CurveSimulator does.                                       |
