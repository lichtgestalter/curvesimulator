...
|----------|--------|--------------------------------------------------------------------------------------------|
| eclipser | -      | Name of the eclipsing body.                                                                |
| tt       | [days] | Time of observed transit midpoint, typically expressed as a Barycentric Julian Date (TDB). |
...
The transit times file can have many additional columns, e.g. T1 and T4 
which can be used to automatically extract transits from flux data. But this 
